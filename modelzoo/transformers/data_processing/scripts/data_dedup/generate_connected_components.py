...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir",type=str,help="Input directory where duplicates generated in previous step are present")
    parser.add_argument("--out_file",type=str,help="Name of the output .pickle file")
